...
import 'package:kitchen_studio_10162023/pages/recipes/create_recipe/create_recipe_v2/widgets/view_only/view_only.dart';
...
class CreateRecipePageV2 extends StatefulWidget {
  final Recipe recipe;
  final double assignedTemperature;

  const CreateRecipePageV2(
      {Key? key, required this.recipe, this.assignedTemperature = 24.0})
      : super(key: key);

  @override
  State<CreateRecipePageV2> createState() => _CreateRecipePageV2State();
}

class _CreateRecipePageV2State extends State<CreateRecipePageV2>
      ...
      children: [
        Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text("${widget.recipe.recipeName} - ${widget.recipe.portion} Portion"),
          ),
          drawer: Container(
            color: Colors.white,
  ...
  Widget getInstructionWidget(BaseOperation operation) {
    if (operation.operation == DockIngredientOperation.CODE) {
      return DockIngredientWidget(
        operation: operation as DockIngredientOperation,
        recipeWidgetActions: this,
      );
    } else if (operation.operation == DropIngredientOperation.CODE) {
      return DropIngredientWidget(
        operation: operation as DropIngredientOperation,
        recipeWidgetActions: this,
      );
    }

    return ViewOnly(operation: operation, recipeWidgetActions: this);
  }
  ...
  void refreshPage() {
    Navigator.of(context).pushReplacement(PageRouteBuilder(
      pageBuilder: (context, animation, secondaryAnimation) =>
        ...
        assignedTemperature: lastAssignedTemperature,
      ),
