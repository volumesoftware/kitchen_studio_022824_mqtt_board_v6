...
class _CookingUnitsPageState extends State<CookingUnitsPage> {
  ...
  void initState() {
    ...
    var connectedDatabase = instance.connectedDatabase;
    try {
    ...
    udpSocket?.send(jsonData.codeUnits, InternetAddress("192.168.43.255"), 8888);
    ...
    return Scaffold(
      ...
      body: GridView.builder(
        ...
        itemBuilder: (context, index) {
          return CookingUnitCardComponent(
            deviceStats: devices[index],
