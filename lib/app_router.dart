...
import 'package:kitchen_studio_10162023/pages/recipes/create_recipe/create_recipe_v2/create_recipe_page_v2.dart';
import 'package:kitchen_studio_10162023/pages/recipes/recipe_web_view.dart';
...
class AppRouter {
  ...
  static const String createRecipePageV2 = "/createRecipePageV2";
  static const String recipeWebView = "/recipeWebView";
  ...
  static Route<dynamic> allRoutes(RouteSettings settings) {
    ...
    switch (name) {
      ...
      case createRecipePageV2:
        {
          return MaterialPageRoute(
              builder: (_) => CreateRecipePageV2(
                    recipe: args as Recipe,
                  ));
        }
      case taskScreen:
      ...
      case recipeWebView:
        {
          return MaterialPageRoute(builder: (_) =>  RecipeWebView(
            recipe: args as Recipe,
